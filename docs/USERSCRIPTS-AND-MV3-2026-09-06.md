...
| [TSWebExtension changelog](https://github.com/AdguardTeam/tsurlfilter/blob/master/packages/tswebextension/CHANGELOG.md), mục 17/4/2026 | Lazy-load/giải phóng metadata có thể giảm đỉnh bộ nhớ | Logger đã có cache giới hạn; đo heap của stock metadata trước khi thay cách nạp, chưa tuyên bố có rò rỉ hay mức giảm RAM |
